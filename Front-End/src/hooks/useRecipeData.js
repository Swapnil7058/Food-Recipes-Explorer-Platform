...
const EXPRESS_API_URL =
  "https://food-recipes-explorer-platform.onrender.com/api";
...
export const useRecipeData = () => {
  ...
  const fetchData = useCallback(async (endpoint, options = {}) => {
    ...
    try {
      ...
      // The "e" is Error object it includes name of error(eg. TypeError, ReferenceError) and error description message
      console.error(`Error fetching from ${url}:`, e);
      setError(
        `Connection Error: ${e.message}. Ensure Express server is running.`,
      );
      return null;
    }
  }, []);
